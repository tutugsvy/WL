window.WSEX_CONFIG = {
  TOKEN: {
    address: "0x2941f3da57779437499b3e065f5e99bd0dcfc0f6", 
    symbol: "WSEX",
    name: "WALLSTREET.EXE",
    decimals: 18,
  ...
  PRICE: {
    ...
    refreshMs: 30_000,     
    pons: {
      chartUrl: "https://chart.wallstreetexe.site/pons-chart?address={address}&range=1h",
      corsProxy: "",
    },
  },
...
MARKET_DATA: {
  ...
  PRODUCT: {
    ...
    utility: [
      ...
      { k: "CULTURE", v: "Finance meets internet culture" },
    ],
  },
};
