...
const feedUrl = `https://api.geckoterminal.com/api/v2/networks/robinhood/tokens/${address}?include=top_pools`;
...
export default function App() {
  ...
  return <main className="react-shell">
    ...
    <section className="hero"><p className="eyebrow">// MARKET TERMINAL / ROBINHOOD CHAIN</p><h1>THE MARKET WAS NEVER<br/><em>MEANT TO RUN THIS WAY.</em></h1><p className="lede">A professional on-chain market interface for $WSEX. Real-time quotes, wallet intelligence, and terminal-grade market data.</p><div className="actions"><a className="primary" href="#market">OPEN TERMINAL</a><a href={`https://robinhoodchain.blockscout.com/token/${address}`}>VIEW CONTRACT ↗</a></div></section>
